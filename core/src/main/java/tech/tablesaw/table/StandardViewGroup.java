...
public class StandardViewGroup extends ViewGroup {
     ...
     */
    public static StandardViewGroup create(Table original, String... columnsNames) {
        List<CategoricalColumn> columns = original.categoricalColumns(columnsNames);
        return new StandardViewGroup(original, columns.toArray(new CategoricalColumn[columns.size()]));
    }
     ...
     * The named columns must be CategoricalColumns
     */
    public static StandardViewGroup create(Table original, CategoricalColumn... columns) {
        return new StandardViewGroup(original, columns);
    }
