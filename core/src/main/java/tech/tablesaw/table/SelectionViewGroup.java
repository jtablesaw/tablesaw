 ...
 */
public class SelectionViewGroup extends ViewGroup {

    public static SelectionViewGroup create(Table original, String subTableNameTemplate, int step) {
        return new SelectionViewGroup(original, subTableNameTemplate, step);
    }

    private SelectionViewGroup(Table original, String subTableNameTemplate, int step) {
        super(original);
