...
public class IsCloseTo extends ColumnFilter {

    private final double target;
    private final double margin;

    public IsCloseTo(ColumnReference reference, double target, double margin) {
        super(reference);
        this.target = target;
        this.margin = margin;
    }
    ...
    public Selection apply(Column columnBeingFiltered) {
        ...
        return numberColumn.isCloseTo(target, margin);
    }
}
