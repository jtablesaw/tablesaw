 ...
 */
public class ColumnLessThan extends TwoColumnFilter {

    public ColumnLessThan(ColumnReference reference, Column otherColumn) {
        super(reference, otherColumn);
    }

    public ColumnLessThan(Column columnToCompareAgainst) {
        super(columnToCompareAgainst);
    }

    public ColumnLessThan(ColumnReference reference, ColumnReference columnToCompareAgainst) {
    ...
    public Selection apply(Column columnToFilter) {
        ...
        return numberColumn.eval(isLessThan, (NumberColumn) otherColumn());
    }
}