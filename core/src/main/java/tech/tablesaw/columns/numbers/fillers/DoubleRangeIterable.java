...
public class DoubleRangeIterable implements DoubleIterable {
    ...
    private DoubleRangeIterable(final double from, final double to, final boolean including, final double by,
            final int count) {
        this.from = from;
        this.to = to;
    ...
    private static DoubleRangeIterable range(final double from, final double to, final double by, final int count) {
