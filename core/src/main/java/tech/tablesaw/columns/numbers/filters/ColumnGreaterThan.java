...
public class ColumnGreaterThan extends TwoColumnFilter {
    ...
    public ColumnGreaterThan(ColumnReference reference, Column otherColumn) {
        super(reference, otherColumn);
    }

    public ColumnGreaterThan(Column columnToCompareAgainst) {
        super(columnToCompareAgainst);
    }

    public ColumnGreaterThan(ColumnReference reference, ColumnReference columnToCompareAgainst) {
    ...
    public Selection apply(Column columnToFilter) {
        ...
        return numberColumn.eval(isGreaterThan, (NumberColumn) otherColumn());
    }
}