...
public class IsThursday extends ColumnFilter {
    ...
    public Selection apply(Column columnBeingFiltered) {
        ...
        switch (type) {
            case LOCAL_DATE:
                ...
                return dateColumn.eval(PackedLocalDate::isThursday);
            case LOCAL_DATE_TIME:
                DateTimeColumn dateTimeColumn = (DateTimeColumn) columnBeingFiltered;
                return dateTimeColumn.eval(PackedLocalDateTime::isThursday);
            default:
