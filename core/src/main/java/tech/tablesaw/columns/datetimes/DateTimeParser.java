...
public class DateTimeParser extends AbstractColumnParser<LocalDateTime> {
  ...
  private static final DateTimeFormatter dtTimef4 =
      caseInsensitiveFormatter("dd-MMM-yyyy HH:mm"); // 09-Jul-2014 13:03
  ...
  private static final DateTimeFormatter dtTimef8 =
      caseInsensitiveFormatter("M/d/yyyy h:mm:ss a"); //  7/9/2014 9:04:55 PM

  /**
   * Creates a Case-insensitive formatter using the specified pattern. This method will create a
   * formatter based on a simple pattern of letters and symbols as described in the class
   * documentation. For example, d MMM yyyy will format 2011-12-03 as '3 Dec 2011'. The formatter
   * will use the default FORMAT locale. This function can handle cases like am/AM, pm/PM, Jan/JAN,
   * Feb/FEB etc
   *
