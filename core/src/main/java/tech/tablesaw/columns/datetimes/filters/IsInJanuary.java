...
public class IsInJanuary extends ColumnFilter {

    public IsInJanuary(ColumnReference reference) {
        super(reference);
    }
    ...
    public Selection apply(Column columnBeingFiltered) {
        ...
        switch (type) {
            case LOCAL_DATE:
                ...
                return dateColumn.eval(PackedLocalDate::isInJanuary);
            case LOCAL_DATE_TIME:
                DateTimeColumn dateTimeColumn = (DateTimeColumn) columnBeingFiltered;
                return dateTimeColumn.eval(PackedLocalDateTime::isInJanuary);
            default:
