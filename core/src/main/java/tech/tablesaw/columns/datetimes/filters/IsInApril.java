...
public class IsInApril extends ColumnFilter {

    public IsInApril(ColumnReference reference) {
        super(reference);
    }
    ...
    public Selection apply(Column columnBeingFiltered) {
        ...
        switch (type) {
            case LOCAL_DATE:
                ...
                return dateColumn.eval(PackedLocalDate::isInApril);
            case LOCAL_DATE_TIME:
                DateTimeColumn dateTimeColumn = (DateTimeColumn) columnBeingFiltered;
                return dateTimeColumn.eval(PackedLocalDateTime::isInApril);
            default:
