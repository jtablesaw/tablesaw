 ...
 */
public class ColumnContainsString extends TwoColumnFilter {

    public ColumnContainsString(StringColumnReference reference, StringColumn otherStringColumn) {
        super(reference, otherStringColumn);
    }

    public ColumnContainsString(StringColumn stringColumnToCompareAgainst) {
        super(stringColumnToCompareAgainst);
    }

    public ColumnContainsString(StringColumnReference reference, StringColumnReference stringColumnToCompareAgainst) {
    ...
    public Selection apply(Column columnToFilter) {
        ...
        return textColumn.eval(String::contains, (StringColumn) otherColumn());
    }
}