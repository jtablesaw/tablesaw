...
public class ColumnNotEqualTo extends TwoColumnFilter {
    ...
    public ColumnNotEqualTo(StringColumnReference reference, StringColumn otherStringColumn) {
        super(reference, otherStringColumn);
    }

    public ColumnNotEqualTo(StringColumn stringColumnToCompareAgainst) {
        super(stringColumnToCompareAgainst);
    }

    public ColumnNotEqualTo(StringColumnReference reference, StringColumnReference stringColumnToCompareAgainst) {
    ...
    public Selection apply(Column columnBeingFiltered) {
        ...
        return textColumn.eval(isNotEqualTo, (StringColumn) otherColumn());
    }
}