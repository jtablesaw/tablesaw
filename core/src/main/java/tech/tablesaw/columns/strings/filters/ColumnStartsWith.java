 ...
 */
public class ColumnStartsWith extends TwoColumnFilter {

    public ColumnStartsWith(StringColumnReference reference, StringColumn otherStringColumn) {
        super(reference, otherStringColumn);
    }

    public ColumnStartsWith(StringColumn stringColumnToCompareAgainst) {
        super(stringColumnToCompareAgainst);
    }

    public ColumnStartsWith(StringColumnReference reference, StringColumnReference stringColumnToCompareAgainst) {
    ...
    public Selection apply(Column columnBeingFiltered) {
        ...
        return textColumn.eval(startsWith, (StringColumn) otherColumn());
    }
}