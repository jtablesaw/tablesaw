 ...
 */
public class ColumnEqualToIgnoringCase extends TwoColumnFilter {

    public ColumnEqualToIgnoringCase(StringColumnReference reference, StringColumn otherStringColumn) {
        super(reference, otherStringColumn);
    }

    public ColumnEqualToIgnoringCase(StringColumn stringColumnToCompareAgainst) {
        super(stringColumnToCompareAgainst);
    }

    public ColumnEqualToIgnoringCase(StringColumnReference reference, StringColumnReference stringColumnToCompareAgainst) {
    ...
    public Selection apply(Column columnToFilter) {
        ...
        return textColumn.eval(isEqualToIgnoringCase, (StringColumn) otherColumn());
    }
}