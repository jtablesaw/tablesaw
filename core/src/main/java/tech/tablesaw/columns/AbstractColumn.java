...
public abstract class AbstractColumn<T> implements Column<T> {
   ...
   */
  public DateColumn mapToDateColumn(
      String name, Function<? super T, ? extends LocalDate> function) {
   ...
   */
  public DateTimeColumn mapToDateTimeColumn(
      String name, Function<? super T, ? extends LocalDateTime> function) {
   ...
   */
  public DoubleColumn mapToDoubleColumn(
      String name, Function<? super T, ? extends Double> function) {
   ...
   */
  public InstantColumn mapToInstantColumn(
      String name, Function<? super T, ? extends Instant> function) {
   ...
   */
  public TimeColumn mapToTimeColumn(
      String name, Function<? super T, ? extends LocalTime> function) {
