...
public class DateParser extends AbstractColumnParser<LocalDate> {
  ...
  private static final DateTimeFormatter dtf7 =
      DateTimeParser.caseInsensitiveFormatter("dd/MMM/yyyy");
  private static final DateTimeFormatter dtf8 =
      DateTimeParser.caseInsensitiveFormatter("dd-MMM-yyyy");
  ...
  private static final DateTimeFormatter dtf11 =
      DateTimeParser.caseInsensitiveFormatter("MMM/dd/yyyy");
  private static final DateTimeFormatter dtf12 =
      DateTimeParser.caseInsensitiveFormatter("MMM-dd-yyyy");
  private static final DateTimeFormatter dtf13 =
      DateTimeParser.caseInsensitiveFormatter("MMM/dd/yy");
  private static final DateTimeFormatter dtf14 =
      DateTimeParser.caseInsensitiveFormatter("MMM-dd-yy");
  private static final DateTimeFormatter dtf15 =
      DateTimeParser.caseInsensitiveFormatter("MMM/dd/yyyy");
  private static final DateTimeFormatter dtf16 =
      DateTimeParser.caseInsensitiveFormatter("MMM/d/yyyy");
  private static final DateTimeFormatter dtf17 =
      DateTimeParser.caseInsensitiveFormatter("MMM-dd-yy");
  private static final DateTimeFormatter dtf18 =
      DateTimeParser.caseInsensitiveFormatter("MMM dd, yyyy");
  private static final DateTimeFormatter dtf19 =
      DateTimeParser.caseInsensitiveFormatter("MMM d, yyyy");
