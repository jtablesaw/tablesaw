...
public class QuerySupport {
    ...
    /**
     * Returns a selection for all records that don't match both of the given functions. In other words,
     * if both sel1 and sel2 are true, the record as a whole is false, and
     * if either (or both) of sel1 or sel2 is {@code false}, the record as a whole is {@code true}.
     */
     ...
     */
    @SafeVarargs
    public static Function<Table, Selection> notAny(Function<Table, Selection> ... deferredSelections) {
     ...
     */
    @SafeVarargs
    public static Function<Table, Selection> notAll(Function<Table, Selection> ... deferredSelections) {
