 ...
 */
public class OldStringColumn extends AbstractStringColumn<OldStringColumn> {
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn appendMissing() {
  ...
  public static OldStringColumn create(String name) {
    return new OldStringColumn(name);
  }

  public static OldStringColumn create(String name, String... strings) {
    return new OldStringColumn(name, strings);
  }

  public static OldStringColumn create(String name, Collection<String> strings) {
    return new OldStringColumn(name, strings);
  }

  public static OldStringColumn createInternal(String name, DictionaryMap map) {
    return new OldStringColumn(name, map);
  }

  public static OldStringColumn create(String name, int size) {
    OldStringColumn column = new OldStringColumn(name, new ArrayList<>(size));
  ...
  public static OldStringColumn create(String name, Stream<String> stream) {
    OldStringColumn column = create(name);
    stream.forEach(column::append);
    return column;
  }

  private OldStringColumn(String name, Collection<String> strings) {
  ...
  private OldStringColumn(String name, DictionaryMap map) {
    super(StringColumnType.instance(), name, StringColumnType.DEFAULT_PARSER);
    lookupTable = map;
  }

  private OldStringColumn(String name) {
    super(StringColumnType.instance(), name, StringColumnType.DEFAULT_PARSER);
  }

  private OldStringColumn(String name, String[] strings) {
    super(StringColumnType.instance(), name, StringColumnType.DEFAULT_PARSER);
    for (String string : strings) {
      append(string);
    }
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn emptyCopy() {
    OldStringColumn empty = create(name());
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn emptyCopy(int rowSize) {
  ...
  public Table summary() {
    ...
    OldStringColumn measure = OldStringColumn.create("Measure");
    OldStringColumn value = OldStringColumn.create("Value");
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn lead(int n) {
    OldStringColumn column = lag(-n);
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn lag(int n) {

    OldStringColumn copy = emptyCopy();
   ...
   */
  @Override
  public OldStringColumn set(Selection rowSelection, String newValue) {
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn set(int rowIndex, String stringValue) {
    if (stringValue == null) {
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn setMissing(int i) {
   ...
   */
  public OldStringColumn addAll(List<String> stringValues) {
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn appendCell(String object) {
    return appendCell(object, parser());
  }

  /** {@inheritDoc} */
  @Override
  public OldStringColumn appendCell(String object, AbstractColumnParser<?> parser) {
   ...
   */
  @Override
  public OldStringColumn unique() {
    List<String> strings = new ArrayList<>(lookupTable.asSet());
    return OldStringColumn.create(name() + " Unique values", strings);
  }
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn where(Selection selection) {
    return subset(selection.toArray());
  }

  /** {@inheritDoc} */
  @Override
  public OldStringColumn copy() {
    OldStringColumn newCol = create(name(), size());
    int r = 0;
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn append(Column<String> column) {
    checkArgument(
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn removeMissing() {
    OldStringColumn noMissing = emptyCopy();
    for (String v : this) {
  ...
  @Override
  public OldStringColumn append(String value) {
    try {
  ...
  /** {@inheritDoc} */
  @Override
  public OldStringColumn appendObj(Object obj) {
    if (obj == null) {
