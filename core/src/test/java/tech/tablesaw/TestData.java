...
public enum TestData {
    SIMPLE_DATA_WITH_CANONICAL_DATE_FORMAT(new String[]{"Name", "IQ", "City", "DOB"},
            new ColumnType[]{ColumnType.STRING, ColumnType.NUMBER, ColumnType.STRING, ColumnType.LOCAL_DATE},
            "../data/simple-data-with-canonical-date-format.csv"),

    SIMPLE_UNSORTED_DATA(new String[]{"Name", "IQ", "City", "DOB"},
            new ColumnType[]{ColumnType.STRING, ColumnType.NUMBER, ColumnType.STRING, ColumnType.LOCAL_DATE}, "../data/unsorted-simple-data.csv"),

    SIMPLE_SORTED_DATA_BY_DOUBLE_ASCENDING(new String[]{"Name", "IQ", "City", "DOB"},
            new ColumnType[]{ColumnType.STRING, ColumnType.NUMBER, ColumnType.STRING, ColumnType.LOCAL_DATE}, "../data/simple-data-sort_by_int_ascending.csv"),

    SIMPLE_SORTED_DATA_BY_DOUBLE_DESCENDING(new String[]{"Name", "IQ", "City", "DOB"},
            new ColumnType[]{ColumnType.STRING, ColumnType.NUMBER, ColumnType.STRING, ColumnType.LOCAL_DATE}, "../data/simple-data-sort_by_int_descending.csv"),
    ...
    SIMPLE_SORTED_DATA_BY_DOUBLE_AND_DATE_DESCENDING(
            new String[]{"Name", "IQ", "City", "DOB"}, new ColumnType[]{ColumnType.STRING, ColumnType.NUMBER, ColumnType.STRING, ColumnType.LOCAL_DATE},
            "../data/simple-data-sort_by_int_and_date_descending.csv"),

    BUSH_APPROVAL(new String[]{"date", "approval", "who"}, new ColumnType[]{ColumnType.LOCAL_DATE, ColumnType.NUMBER, ColumnType.STRING},
            "../data/bush.csv"),
    ...
    TORNADOES(new String[]{"Number", "Year", "Month", "Day", "Date", "Time", "Zone", "State", "State FIPS", "State No",
            ...
            new ColumnType[]{ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.LOCAL_DATE, ColumnType.LOCAL_TIME, ColumnType.STRING, ColumnType.STRING, ColumnType.STRING,
                    ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.NUMBER,
                    ColumnType.NUMBER, ColumnType.NUMBER, ColumnType.STRING, ColumnType.STRING, ColumnType.STRING, ColumnType.STRING}, "../data/1950-2014_torn.csv");
