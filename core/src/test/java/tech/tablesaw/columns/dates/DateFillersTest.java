...
public class DateFillersTest {
    ...
    public void testFromToBy() {
        testValues(createWith("dates", 5, range(LocalDate.of(2018, 3, 1), // year, month, day
                LocalDate.of(2019, 3, 1), 1, ChronoUnit.DAYS)), LocalDate.of(2018, 3, 1), // year, month, day
                LocalDate.of(2018, 3, 2), LocalDate.of(2018, 3, 3), LocalDate.of(2018, 3, 4), LocalDate.of(2018, 3, 5));
        testValues(createWith("dates", 5, range(LocalDate.of(2018, 3, 1), // year, month, day
