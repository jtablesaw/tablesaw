...
public class DataFrameJoinerPerformanceTest {
    ...
    private static Table createCustomersTable(int numberCustomers) {
        ...
        IntColumn customerIds = IntColumn.create("customerId", IntStream.range(0, numberCustomers).toArray());
    ...
    private static Table createOrdersTable(int numberOrders, int numberCustomers) {
        ...
        IntColumn orderCustomerIds = IntColumn.create("customerId",
            random.doubles().limit(numberOrders)
                .mapToInt(randomDouble -> (int) Math.floor(randomDouble * numberCustomers)).toArray());
