...
public class TukeyMeanDifferencePlot {
    ...
    /**
     * Returns a double array, whose values are quantiles from the given source, based on the given size.
     * The idea is to produce size elements that represent the quantiles of source array
