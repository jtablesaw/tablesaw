...
public class HorizontalBarPlot extends BarPlot {
    ...
    public static Figure create(String title, Table table, String groupColName, String... numberColNames) {
        return BarPlot.create(Orientation.HORIZONTAL, title, table, groupColName, numberColNames);
    }
}
