 ...
 *
 */
public class GlimpseHistogram implements GlimpseLayoutProvider {
  ...
  public static void show(NumericColumn column) {
    GlimpseHistogram plot = new GlimpseHistogram(column);
    try {
  ...
  public GlimpseHistogram(NumericColumn column) {
    this.column = column;
