 ...
 */
public class GlimpseLine implements GlimpseLayoutProvider {
  ...
  public GlimpseLine(NumericColumn x, NumericColumn ... seriesYvalues) throws IOException {
  ...
  public GlimpseLine(String plotTitle, NumericColumn x, NumericColumn ... seriesYvalues) throws IOException {
  ...
  public SimplePlot2D getLayout() {
    ...
    java.util.List<Color> colors = StandardColors.standardColors();
  ...
  public static void show(NumericColumn x, NumericColumn y) {
    try {
      Display.showWithSwing(new GlimpseLine(x, y));
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public static void show(String plotTitle, NumericColumn x, NumericColumn y) {
    try {
      Display.showWithSwing(new GlimpseLine(plotTitle, x, y));
    } catch (Exception e) {
      e.printStackTrace();
      throw new RuntimeException(e);
    }
