...
class OrcReaderTest {
  ...
  void testReadForSupportedTypes() {
    ...
    try {
      ...
      assertColumnValues(
          table.dateTimeColumn("times"), localDateTime, localDateTime, localDateTime);
      ...
      assertColumnValues(
          table.longColumn("somelong"), 922337203685477L, 922337203685478L, 922337203685479L);
  ...
  void testReadForRepeatingValues() {
    ...
    try {
      ...
      assertColumnValues(
          table.longColumn("somelong"), 922337203685477L, 922337203685477L, 922337203685477L);
      assertColumnValues(table.doubleColumn("somedouble"), 0D, 7990979.8789, 15981959.7578);
